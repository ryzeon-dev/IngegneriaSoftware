...
public class AirportGraphTest {
    ...
    public void graphTest() {
        ...
        Airport a3= new Airport("a3", DimensionClass.fromString("4E"), "T3", "T3", "T3");
        Airport a4= new Airport("a4", DimensionClass.fromString("4E"), "T4", "T4", "T4");

        AirportGraph graph= new AirportGraph();

        graph.addEdge(a1, a2,10,1,30);
        graph.addEdge(a1, a3, 40,2,90);
        graph.addEdge(a2, a1,10,3,40);
        graph.addEdge(a3, a2,20,4,60);

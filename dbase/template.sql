...
ALTER TABLE public.aircraft OWNER TO master;
...
ALTER SEQUENCE public.aircraft_id_seq OWNER TO master;
...
ALTER TABLE public.aircraft_instance OWNER TO master;
...
ALTER TABLE public.airport OWNER TO master;
...
ALTER TABLE public.commanders OWNER TO master;
...
ALTER TABLE public.credentials OWNER TO master;
...
ALTER TABLE public.first_officer OWNER TO master;
...
ALTER TABLE public.flight OWNER TO master;
...
ALTER TABLE public.flight_assistants OWNER TO master;
...
ALTER SEQUENCE public.flight_id_seq OWNER TO master;
...
ALTER TABLE public.parking OWNER TO master;
...
ALTER TABLE public.personal OWNER TO master;
...
ALTER SEQUENCE public.personal_id_seq OWNER TO master;
...
ALTER TABLE public.route OWNER TO master;
...
ALTER SEQUENCE public.route_id_seq OWNER TO master;
